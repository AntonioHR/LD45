#if !defined(COMBINED_ACCENT_SHAPE_LIGHT_PASS)
#define COMBINED_ACCENT_SHAPE_LIGHT_PASS

half _HDREmulationScale;

half4 CombinedAccentShapeLightShared(half4 color, half4 mask, half2 lightingUV)
{
